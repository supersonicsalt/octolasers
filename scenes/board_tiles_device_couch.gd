...
func _on_input_text_changed() -> void:
	...
	if width == 0:
		width = 12
	if height % 2 == 1:
		transform.origin.x = 160 - (4 * scale.x)
		$"../OctodotTiles".transform.origin.x = 160 - (4 * scale.x)
		$"../LaserTiles".transform.origin.x = 160 - (4 * scale.x)
	else:
		transform.origin.x = 160
		$"../OctodotTiles".transform.origin.x = 160
		$"../LaserTiles".transform.origin.x = 160
	if width % 2 == 1:
		transform.origin.y = 90 - (4 * scale.y)
		$"../OctodotTiles".transform.origin.y = 90 - (4 * scale.y)
		$"../LaserTiles".transform.origin.y = 90 - (4 * scale.y)
	else:
		transform.origin.y = 90
		$"../OctodotTiles".transform.origin.y = 90
		$"../LaserTiles".transform.origin.y = 90
	clear()
	$"../OctodotTiles".clear()
	$"../LaserTiles".clear()
